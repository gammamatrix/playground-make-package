...
This package provides an API without UI for interacting with the [{{ model_package_name }}](https://github.com/gammamatrix/{{ model_package }}), a model package for Laravel.

If you need a JSON API with a UI, then have a look at [{{ model_package_name }} Resource.](https://github.com/gammamatrix/{{ model_package }}-resource)
